...
// const ReportPage = () => {
//   // Initial static data - will be replaced by API data
...
//   /*
//   * UNCOMMENT THIS SECTION WHEN CONNECTING TO BACKEND
//   * This useEffect hook will fetch data when the component mounts
//   */
//   /*
//   useEffect(() => {
...
//   /*
//   * UNCOMMENT THIS SECTION IF YOU WANT TO PASS DATA AS PROPS
//   * Remove the useState and useEffect above if using props
//   */
//   /*
...
//                 <Link to="/edit-report-page" className=" text-xl text-transparent bg-clip-text bg-gradient-to-r from-[#d8b4fe] to-[#60a5fa] ">
//                     Edit Report
//                 </Link>
//                 </div>
...
//             className="px-6 py-3  bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] transition rounded-md   font-semibold text-white"
//             /*
//             * Add onClick handler for upload functionality
//             */
//             /*
//             onClick={() => {
//               // Handle upload functionality here
//               console.log('Upload another scan clicked');
//             }}
//             */
//           >
//             Upload Another Scan
...
//             className="px-6 py-3  bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] transition rounded-md   font-semibold text-white"
//             /*
//             * Add onClick handler for PDF download
//             */
//             /*
//             onClick={() => {
//               // Handle PDF download functionality here
